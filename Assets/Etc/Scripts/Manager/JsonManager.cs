...
"  \"윌리엄의 역할\": \"윌리엄은 오리온 캐피탈(Orion Capital)의 부사장으로, 자신의 연인인 엠마의 소개로 헨리를 알게 되었고 그의 병원에 투자하게 되었습니다. 헨리의 병원 재무 상태를 검토하는 과정에서 분식회계와 의료사고 은폐 정황을 발견하여 투자 철회를 진행하려 했습니다. 헨리는 투자 철회는 부당하다며 소송을 제기했지만 얼마 뒤 살해당했습니다.\",\n" +
